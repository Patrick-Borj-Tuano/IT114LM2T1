...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator runat="server" ControlToValidate="fullName" ErrorMessage="Please enter your full name" Display="Dynamic" /> <br />
        ...
        <%-- Hint: https://www.tutorialspoint.com/asp.net/asp.net_validators.htm#:~:text=RangeValidator%20Control--%>
         <asp:RequiredFieldValidator runat="server" ControlToValidate="age" ErrorMessage="Please enter your age" Display="Dynamic" /> <br />
        ...
        <%-- Hint: https://www.tutorialspoint.com/asp.net/asp.net_validators.htm#:~:text=The%20RegularExpressionValidator%20allows --%>
         <asp:RequiredFieldValidator runat="server" ControlToValidate="email" ErrorMessage="Please enter your email" Display="Dynamic" /> <br />
        ...
        <%-- Hint: https://www.tutorialspoint.com/asp.net/asp.net_validators.htm#:~:text=CompareValidator%20Control --%>
         <asp:RequiredFieldValidator runat="server" ControlToValidate="confirmEmail" ErrorMessage="Please enter your confirmation email" Display="Dynamic" /> <br />
        <asp:CompareValidator runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" ErrorMessage="Email and Confirm Email must match" /><br />

        <asp:Button Text="Submit" runat="server" UseSubmitBehavior="true" OnClick="Submit_Click"/> <br />
